...
function JobCard({ job, activeJob }: JobProps) {
  ...
  const companyDescription =
    "SkillSync connects job seekers with employers, enabling job searches, applications, and resume uploads for candidates, while allowing employers to post jobs and manage hires."
